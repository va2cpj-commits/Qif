...
#define FORWARD           0
#define REVERSE           1
#define ACTUATOR_MAX      10                                                                        // Maximum time an actuator takes to reach its position (seconds)
...
uint8_t  Value1   = 0;                                                                              // Argument 2 (channel)
uint8_t  Value2   = 0;                                                                              // Argument 3 (value)

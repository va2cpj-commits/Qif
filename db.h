...
/*
  ...
  Attributes:
  CAN, LBL, and TYPE are configuration details for each board.
  PINS contains the pin configuration for the board.
  Pins Initialization for Different Boards
*/
// ---------- Compact link (8-bit base, 4-bit sub) ----------
typedef struct {
  uint8_t base : 8;                                                                 // 0..255  (target board label)
  uint8_t sub  : 4;                                                                 // 0..15   (channel / feature)
  uint8_t pad  : 4;                                                                 // unused
} LINK;
...
static constexpr LINK F = { 0xFF, 0x0F, 0 };                                          // “free / unlinked” sentinel
static constexpr LINK L(uint8_t base, uint8_t sub) {
  return LINK{ base, (uint8_t)(sub & 0x0F), 0 };
}
...
const IO DB[128] = {
  { .UID=uid000, .CAN=board000, .LBL=0,   .TYPE=UNDEF,
    .lnk={ F,F,F,F, F,F,F,F, F,F,F,F, F,F,F,F } },

  { .UID=uid001, .CAN=board001, .LBL=1,   .TYPE=LPOWER,
    .lnk={ F,F,F,F, F,F,F,F, F,F,F,F, F,F,F,L(2,Bme) } },

  { .UID=uid002, .CAN=board002, .LBL=2,   .TYPE=SWITCH,
    .lnk={ L(4,led0),L(4,led1),L(4,led2),L(4,led3),
           L(4,led6),L(4,led5),L(4,led6),L(4,led7),
           F,F,F,F, F,F,F,F } },

  { .UID=uid003, .CAN=board003, .LBL=3,   .TYPE=UNDEF,
    .lnk={ F,F,F,F, F,F,F,F, F,F,F,F, F,F,F,F } },

  { .UID=uid004, .CAN=board004, .LBL=4,   .TYPE=SWITCH,
    .lnk={ L(2,led0),L(2,led1),L(2,led2),L(2,led3),
           L(2,led6),L(2,led5),L(2,led6),L(2,led7),
           F,F,F,F, F,F,F,F } },
  ...
  { .UID=uid050, .CAN=board050, .LBL=50,  .TYPE=MPOWER,
    .lnk={ F,F,F,F, F,F,F,F, F,F,F,F, F,F,F,F } },
  ...
  { .UID=uid100, .CAN=board100, .LBL=100, .TYPE=SWITCH,
    .lnk={ L(102,led0),L(102,led1),L(102,led2),L(102,led3),
           L(102,led6),L(102,led5),L(102,led6),L(102,led7),
           F,F,F,F, F,F,F,F } },

  { .UID=uid101, .CAN=board101, .LBL=101, .TYPE=MPOWER,
    .lnk={ L(102,led0),L(102,led1),L(102,led2),L(102,led3),
           L(102,led4),L(102,led5),F,F, F,F,F,F, F,F,F,F } },

  { .UID=uid102, .CAN=board102, .LBL=102, .TYPE=SWITCH,
    .lnk={ L(101,pwm0),L(101,pwm1),L(101,led2),L(101,pwm3),
           L(101,pwm4),L(101,pwm5),L(100,led0),L(100,led1),
           F,F,F,F, F,F,F,F } },
